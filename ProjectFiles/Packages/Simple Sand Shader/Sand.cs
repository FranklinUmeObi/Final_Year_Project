...
namespace vEKUGames.SimpleSand
{
    public class Sand : MonoBehaviour
    {
       ...
       // private TrackedEntity m_trackedEntity2;
        //[SerializeField]

        [SerializeField]
         TrackedEntity m_trackedEntity;
         //TrackedEntity m_trackedEntity2;
        [SerializeField]
        ...
        private void UpdateEntityVelocity(Vector3 velocity)
        {
            ...
            //Debug.Log("Velocity Of ball: " + entityVelocity);
        }
        ...
        private void UpdateEntityPercentUnderground()
        {
            ...
            if (Physics.Raycast(ray, out raycastHit, m_trackedEntity.Radius * 3, m_groundLayer))
            {
                ...
                percentUnderground = Mathf.InverseLerp(m_trackedEntity.Radius, 0, distance)*1f;//i edited
            }
